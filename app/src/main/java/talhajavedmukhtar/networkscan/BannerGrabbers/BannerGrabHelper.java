...
public class BannerGrabHelper extends AsyncTask{
    private final String TAG = Tags.makeTag("BannerGrabHelper");
    ...
    public BannerGrabHelper(Context ctx, ArrayList<String> ipAds, ArrayList<String> bMD, ArrayAdapter<String> adap, ArrayList<String> bMR, int cTO, int gTO){
        ips = ipAds;
